...
const flokipumpTokenData = [
  {
    ...
    percentage: 32,
    color: "#FACC15",
    description: "1,600,000,000 Brat kissing millhouse – To raise funds for development and marketing.",
  },
  {
    name: "DEX Liquidity (Raydium)",
    percentage: 20,
    color: "#22C55E",
    description: "1,000,000,000 Brat kissing millhouse – Locked 6–12 months to secure the project.",
  },
  {
    name: "Team & Development",
    percentage: 16,
    color: "#EF4444",
    description: "800,000,000 Brat kissing millhouse – Vested 6–12 months, no immediate access.",
  },
  {
    name: "Marketing & Partnerships",
    percentage: 12,
    color: "#3B82F6",
    description: "600,000,000 Brat kissing millhouse – For promotion and strategic partners.",
  },
  {
    name: "CEX Listings & Liquidity",
    percentage: 10,
    color: "#A855F7",
    description: "500,000,000 Brat kissing millhouse – Locked 6 months for CEX listings.",
  },
  {
    name: "Community Rewards / Airdrops",
    percentage: 6,
    color: "#F97316",
    description: "300,000,000 Brat kissing millhouse – Rewards for early supporters and community.",
  },
  {
    name: "Reserve / Future Use",
    percentage: 4,
    color: "#64748B",
    description: "200,000,000 Brat kissing millhouse – For future development and opportunities.",
  },
];
    ...
    >
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          >
            TOTAL SUPPLY: 5,000,000,000 Brat kissing millhouse
          </motion.p>
        </motion.div>
